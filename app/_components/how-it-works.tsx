    ...
    <section className="relative bg-background py-20 sm:py-24">
      <div className="container mx-auto max-w-[100rem] px-5 md:px-14 lg:px-20">
        <div className="mx-auto max-w-[40rem] text-center">
          ...
          <p className="mx-auto mt-3 max-w-[32rem] text-sm leading-6 text-muted-foreground sm:text-base">
        ...
        <ol className="mt-12 grid gap-5 md:grid-cols-3">
          {STEPS.map((step, index) => {
            ...
            return (
              <li
                key={step.title}
              className="group relative flex flex-col rounded-2xl border border-border bg-card p-6 shadow-[0_18px_45px_rgba(31,53,92,0.04)] transition-shadow hover:shadow-[0_24px_60px_rgba(31,53,92,0.08)]"
              >
